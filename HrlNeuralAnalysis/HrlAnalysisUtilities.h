...
*/
#ifndef HRLANALYSISUTILITIES_H_
#define HRLANALYSISUTILITIES_H_
...
typedef boost::shared_ptr< StateDistance > StateDistancePtr;
...
// ToDo: Move calcSPIKEDistanceAvg

// ToDo: Move calcSPIKEDistanceAvg

}
#endif /* HRLANALYSISUTILITIES_H_ */
